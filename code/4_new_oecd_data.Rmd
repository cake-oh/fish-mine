...
print(unique(valueadded_data$Economic.activity))
fish_finaladd <- valueadded_data %>% filter(Economic.activity == "Fishing and aquaculture")  %>% filter(Transaction =="Value added, gross") %>% select(-c(Economic.activity, TRANSACTION,ACTIVITY, Transaction))
