...
# head(gdp_data4)
# List of countries in OECD data we want to use

##THIS WAS ALL USING OUTDATED API CALL
# gdp_data <- get_dataset("SNA_TABLE1")
# dim(gdp_data)
# countries <- unique(gdp_data$LOCATION)
# 
# for (country in countries) {
#   country_data <- get_dataset("SNA_TABLE1", filter = list(country))
#   if (country == countries[1]) {
#     df_gdp <- country_data
#   } else {
#     df_gdp <- rbind(df_gdp, country_data)
#   }
# }
# 
# dataset <- "OECD.SDD.NAD,DSD_NAMAIN10@DF_TABLE1_EXPENDITURE,1.0"
#  url <- paste0(
#     "https://sdmx.oecd.org/public/rest/dataflow/", dataset, "?references=all"
#   )
#   data_structure <- rsdmx::readSDMX(url)

#setwd one level up and to Deepsea folder
```
